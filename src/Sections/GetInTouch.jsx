...
function GetInTouch() {
  return (
    <>
        ...
        <p className='text-[#8892b0] font-Stack2 w-[550px] text-center text-lg'>I’m currently looking for opportunities. Whether you have a question or just want to say hi, I’ll try my best to get back to you!</p>
